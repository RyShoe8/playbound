...
export const metadata: Metadata = {
  title: "Connect — Game Servers Admin",
    ...
    <div className="space-y-6 px-4 py-6 sm:px-6 lg:px-8">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <h1 className="mt-2 text-2xl font-bold tracking-tight">Connect</h1>
          <p className="mt-1 max-w-2xl text-sm text-muted-foreground">
            Live VPS resources, dedicated game-host health, and active party rooms for PlayBound Connect.
          </p>
        </div>
        <Link
          href="/connect"
