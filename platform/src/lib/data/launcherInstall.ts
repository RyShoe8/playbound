...
export const launcherInstallBySlug: Record<string, LauncherInstall> = {
  ...
  freeciv: {
    enabled: true,
    kind: "external",
    url: "https://www.freeciv.org/download.html",
    note: "Download the Windows installer from freeciv.org (or use your package manager).",
  },
  flightgear: {
    enabled: true,
    kind: "external",
    url: "https://www.flightgear.org/download/",
    note: "Large download — use the official FlightGear Windows installer.",
  },
  freedoom: {
    enabled: true,
    kind: "github-zip",
