...
export const launcherInstallBySlug: Record<string, LauncherInstall> = {
  ...
  "the-dark-mod": {
    ...
    note: "Official standalone installer. Windows and Mac (via PlayBound Wine) use the Windows zip; Linux uses the native linux64 installer.",
  },
  "goldeneye-source": {
    enabled: true,
  ...
  "unknown-horizons": {
    ...
    note: "Official 2019.1 Windows setup. Mac/Linux use Wine. Play launches unknownhorizons.exe, not run_uh.bat.",
  },
  "the-spike-cross": {
    enabled: true,
    kind: "external",
