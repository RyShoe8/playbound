...
export const launcherInstallBySlug: Record<string, LauncherInstall> = {
  ...
  "the-dark-mod": {
    ...
    knownExePaths: [
      ...
      "%COMPAT_PREFIXES%/the-dark-mod/drive_c/Program Files/TheDarkMod/TheDarkModx64.exe",
      "%COMPAT_PREFIXES%/the-dark-mod/drive_c/Program Files (x86)/TheDarkMod/TheDarkModx64.exe",
      "%COMPAT_PREFIXES%/the-dark-mod/drive_c/Program Files/The Dark Mod/TheDarkModx64.exe",
      "%COMPAT_PREFIXES%/the-dark-mod/drive_c/Program Files (x86)/The Dark Mod/TheDarkModx64.exe",
      "%COMPAT_PREFIXES%/the-dark-mod/drive_c/Games/TheDarkMod/TheDarkModx64.exe",
      "TheDarkModx64.exe",
      "TheDarkMod.exe",
      "DarkMod.exe",
      "thedarkmod.x64",
    ],
    note: "PlayBound runs the official tdm_installer unattended. Windows and Mac (via Wine) use the Windows zip; Linux uses the native linux64 installer.",
  },
  "goldeneye-source": {
    enabled: true,
  ...
  assaultcube: {
    ...
    assetPatternMac: "AssaultCube_.*\\.dmg$",
    assetPatternLinux: "AssaultCube_.*\\.tar\\.bz2$",
    exeHint: "ac_client|linux_64_client|linux_client",
    ...
    knownExePaths: [
      ...
      "%APPLICATIONS%/AssaultCube.app",
      "%HOME_APPLICATIONS%/AssaultCube.app",
      "bin_unix/linux_64_client",
      "bin_unix/linux_client",
      "bin_unix/ac_client",
    ],
    unwrapSingleRoot: true,
    note: "Official AssaultCube Lockdown release — Windows setup, Mac DMG, or Linux tar.bz2.",
  },
  openclonk: {
    enabled: true,
    kind: "direct-installer",
  ...
  "alien-swarm": {
    ...
    connectArgs: ["+connect", "{host}:{port}"],
    knownExePaths: [
      "%PROGRAMFILES(X86)%\\Steam\\steamapps\\common\\alien swarm\\swarm.exe",
      "%PROGRAMFILES%\\Steam\\steamapps\\common\\alien swarm\\swarm.exe",
    ],
    note: "Free on Steam — Steam handles the download and the install. Multiplayer connects via Source engine +connect {host}:{port}.",
  },
  "alien-swarm-reactive-drop": {
    ...
    connectArgs: ["+connect", "{host}:{port}"],
    knownExePaths: [
      "%PROGRAMFILES(X86)%\\Steam\\steamapps\\common\\Alien Swarm Reactive Drop\\reactivedrop.exe",
      "%PROGRAMFILES%\\Steam\\steamapps\\common\\Alien Swarm Reactive Drop\\swarm.exe",
      "%PROGRAMFILES%\\Steam\\steamapps\\common\\Alien Swarm Reactive Drop\\AlienSwarmReactiveDrop.exe",
      "%PROGRAMFILES%\\Steam\\steamapps\\common\\Alien Swarm Reactive Drop\\reactivedrop_x64.exe",
    ],
    note: "Free community continuation on Steam with official full controller support and active multiplayer.",
  },
  warfork: {
    enabled: true,
    kind: "steamcmd",
  ...
  "space-station-14": {
    ...
    needsDotNetMajor: 10,
    note: "Official SS14 Launcher — Windows, macOS, and Linux zips from GitHub. Game content downloads per server on first join.",
  },
  "warzone-2100": {
    enabled: true,
    kind: "github-zip",
  ...
  trackmania: {
    ...
    versionLabel: "Ubisoft Connect",
    exeHint: "Trackmania|upc",
    registryTitles: ["Ubisoft Connect", "Trackmania"],
    knownExePaths: [
      "%PROGRAMFILES%\\Ubisoft\\Ubisoft Game Launcher\\games\\Trackmania\\Trackmania.exe",
      "%PROGRAMFILES(X86)%\\Ubisoft\\Ubisoft Game Launcher\\games\\Trackmania\\Trackmania.exe",
      "%PROGRAMFILES%\\Ubisoft\\Ubisoft Game Launcher\\upc.exe",
      "%PROGRAMFILES(X86)%\\Ubisoft\\Ubisoft Game Launcher\\upc.exe",
    ],
    note: "Installs Ubisoft Connect (no Steam). Sign in, then install Trackmania Starter Access from your Connect library.",
  },
  "unknown-horizons": {
    enabled: true,
    kind: "direct-installer",
    ...
    note: "Official 2019.1 Windows setup. PlayBound runs it silently; Play starts run_uh via bundled Python.",
  },
  "the-spike-cross": {
    enabled: true,
    kind: "external",
    ...
    steamAppId: "3983810",
    versionLabel: "Steam",
    note: "Free on Steam only — no DRM-free or non-Steam PC build exists. steam://install starts the one-click Steam install.",
  },
  "populous-the-beginning": {
    enabled: true,
    kind: "external",
    url: "https://www.gog.com/en/game/populous_the_beginning",
    knownExePaths: ["popTB.exe", "d3dpoptb.exe", "Populous.exe"],
  ...
  "earth-2140-trilogy": {
    ...
    note: "Uses GOG's DRM-free offline installer. Prefer the OpenE2140 edition after purchase.",
  },
  "super-sidekicks": {
    enabled: true,
    kind: "external",
    url: "goggalaxy://openGameView/1410950050",
    knownExePaths: [
      "%PROGRAMFILES(X86)%\\GOG Galaxy\\Games\\SUPER SIDEKICKS\\ssideki.zip",
      "%PROGRAMFILES%\\GOG Galaxy\\Games\\SUPER SIDEKICKS\\ssideki.zip",
      "C:\\GOG Games\\SUPER SIDEKICKS\\ssideki.zip",
      "ssideki.zip",
      "%PROGRAMFILES(X86)%\\GOG Galaxy\\Games\\SUPER SIDEKICKS\\SUPER SIDEKICKS.exe",
      "%PROGRAMFILES%\\GOG Galaxy\\Games\\SUPER SIDEKICKS\\SUPER SIDEKICKS.exe",
      "C:\\GOG Games\\SUPER SIDEKICKS\\SUPER SIDEKICKS.exe",
      "SUPER SIDEKICKS.exe",
    ],
  ...
  "baseball-stars-2": {
    ...
    knownExePaths: [
      "%PROGRAMFILES(X86)%\\GOG Galaxy\\Games\\BASEBALL STARS 2\\bstars2.zip",
      "%PROGRAMFILES%\\GOG Galaxy\\Games\\BASEBALL STARS 2\\bstars2.zip",
      "C:\\GOG Games\\BASEBALL STARS 2\\bstars2.zip",
      "bstars2.zip",
      "%PROGRAMFILES(X86)%\\GOG Galaxy\\Games\\BASEBALL STARS 2\\BASEBALL STARS 2.exe",
      "%PROGRAMFILES%\\GOG Galaxy\\Games\\BASEBALL STARS 2\\BASEBALL STARS 2.exe",
      "C:\\GOG Games\\BASEBALL STARS 2\\BASEBALL STARS 2.exe",
      "BASEBALL STARS 2.exe",
    ],
    note: "Opens GOG Galaxy for your owned copy. PlayBound detects the install, then uses RetroArch/FBNeo for Connect netplay.",
  },
  "soccer-brawl": {
    enabled: true,
    kind: "external",
    url: "goggalaxy://openGameView/1097533180",
    knownExePaths: [
      "%PROGRAMFILES(X86)%\\GOG Galaxy\\Games\\SOCCER BRAWL\\socbrawl.zip",
      "%PROGRAMFILES%\\GOG Galaxy\\Games\\SOCCER BRAWL\\socbrawl.zip",
      "C:\\GOG Games\\SOCCER BRAWL\\socbrawl.zip",
      "socbrawl.zip",
      "%PROGRAMFILES(X86)%\\GOG Galaxy\\Games\\SOCCER BRAWL\\SOCCER BRAWL.exe",
      "%PROGRAMFILES%\\GOG Galaxy\\Games\\SOCCER BRAWL\\SOCCER BRAWL.exe",
      "C:\\GOG Games\\SOCCER BRAWL\\SOCCER BRAWL.exe",
      "SOCCER BRAWL.exe",
    ],
    note: "Opens GOG Galaxy for your owned copy. PlayBound detects the install, then uses RetroArch/FBNeo for Connect netplay.",
  },
  ...
  srb2kart: {
    enabled: true,
    kind: "direct-installer",
    url: "https://github.com/STJr/Kart-Public/releases/download/v1.6/srb2kart-v16-Installer.exe",
    urlMac: "https://github.com/STJr/Kart-Public/releases/download/v1.6/SRB2Kart-1.6-macOS.dmg",
    fileName: "srb2kart-v16-Installer.exe",
    exeHint: "srb2kart",
    versionLabel: "1.6",
    registryTitles: ["SRB2Kart"],
    knownExePaths: [
      "%PROGRAMFILES%\\SRB2Kart\\srb2kart.exe",
      "%PROGRAMFILES(X86)%\\SRB2Kart\\srb2kart.exe",
      "srb2kart.exe",
    ],
  ...
  "pokemon-blaze-online": {
    ...
    versionLabel: "Desktop 64-bit",
    exeHint: "pbo|pokemonblazeonline|PBO",
    knownExePaths: [
      "%GAMES%\\pokemon-blaze-online\\pbo.exe",
      "%GAMES%\\pokemon-blaze-online\\PBO.exe",
      "pbo.exe",
      "PBO.exe",
      "pbo",
    ...
    note: "Extracts official 64-bit PBO desktop build. Linux users receive native x86_64 tarball; Mac users receive DMG.",
  },
  pokemmo: {
    enabled: true,
    kind: "direct-zip",
    ...
    knownExePaths: [
      "%GAMES%\\pokemmo\\PokeMMO.exe",
      "%GAMES%\\pokemmo\\PokeMMO.sh",
      "PokeMMO.exe",
      "PokeMMO.sh",
    ],
    registryTitles: ["PokeMMO"],
    note: "Unpacks official portable client. Runs PokeMMO.exe on Windows, PokeMMO.sh on Linux. Supply your legal ROMs (Black/White required) on first launch.",
  },
  "castlevania-revamped": {
    ...
    knownExePaths: [
      "%GAMES%\\castlevania-revamped\\Castlevania ReVamped.exe",
      "%GAMES%\\castlevania-revamped\\CastlevaniaReVamped.exe",
  ...
  "hawken-hawkening": {
    ...
    versionLabel: "Hawkening Client",
    exeHint: "Hawkening|Hawken|Hawken-Win32-Shipping",
    knownExePaths: [
      "%GAMES%\\hawken-hawkening\\Hawken.exe",
      "%LOCALAPPDATA%\\Hawkening\\Hawken.exe",
      "Hawken.exe",
      "Hawken-Win32-Shipping.exe",
    ],
    registryTitles: ["Hawkening", "HAWKEN"],
    note: "Installs the official Hawkening community client. Enlist your pilot callsign at hawakening.com before initial launch.",
  },
};
