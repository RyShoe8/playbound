...
const holocureMods: ModSeed[] = [
  m({
    ...
    path: "mods",
    website: "https://github.com/PippleCultist/HoloCureMultiplayerMod",
    repo: "PippleCultist/HoloCureMultiplayerMod",
    kind: "github-zip",
    pattern: ".*\\.zip$",
    size: 25,
    year: 2024,
  ...
  m({
    ...
    baseTitle: "HoloCure - Save the Fans!",
    path: "mods",
    website: "https://github.com/PippleCultist/HoloCureSandboxMod",
    repo: "PippleCultist/HoloCureSandboxMod",
    kind: "github-zip",
    pattern: ".*\\.zip$",
    size: 15,
    year: 2024,
  ...
  m({
    ...
    baseTitle: "HoloCure - Save the Fans!",
    path: "mods",
    website: "https://github.com/PippleCultist/HoloCureCharacterCreatorMod",
    repo: "PippleCultist/HoloCureCharacterCreatorMod",
    kind: "github-zip",
    pattern: ".*\\.zip$",
    size: 35,
    year: 2024,
  ...
  m({
    ...
    baseTitle: "HoloCure - Save the Fans!",
    path: "mods",
    website: "https://github.com/mashirochan/HoloCure-DiscordRPC",
    repo: "mashirochan/HoloCure-DiscordRPC",
    kind: "github-zip",
    pattern: ".*\\.zip$",
    size: 5,
    year: 2024,
