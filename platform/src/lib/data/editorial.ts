...
export const editorial: Record<string, GameEditorial> = {
  openra: {
    qualityBar: clearsAll(
      "OpenRA clears all five: genuinely free with no monetisation, stable and complete, actively developed, good enough to recommend at full price, and open-source under GPL-3.0 so nothing can take it away."
    ),
    longDescription:
  ...
  "beyond-all-reason": {
    qualityBar: clearsAll(
      "Beyond All Reason clears all five: free with no monetisation, complete and stable, under very active development, competitive with commercial large-scale RTS games, and open-source so it cannot be shut down."
    ),
    longDescription:
  ...
  "zero-k": {
    qualityBar: clearsAll(
      "Zero-K clears all five: free with no monetisation, mature and complete, actively maintained, genuinely excellent on its own merits, and open-source so it cannot disappear."
    ),
    longDescription:
  ...
  mindustry: {
    qualityBar: clearsAll(
      "Mindustry clears all five: free with no monetisation on desktop, complete and heavily content-rich, actively developed, easily good enough to sell, and open-source under GPL-3.0."
    ),
    longDescription:
  ...
  openttd: {
    qualityBar: clearsAll(
      "OpenTTD clears all five: free with no monetisation, exceptionally complete after two decades of refinement, still actively developed, better than the commercial game it descends from, and open-source so it cannot be lost."
    ),
    longDescription:
  ...
  luanti: {
    qualityBar: clearsAll(
      "Luanti clears all five: free with no monetisation, a mature and stable engine, actively developed, genuinely excellent as a platform, and open-source so it cannot be taken away."
    ),
    longDescription:
  ...
  "endless-sky": {
    qualityBar: clearsAll(
      "Endless Sky clears all five: free with no monetisation, complete with multiple full story campaigns, actively maintained, comfortably worth a commercial price, and open-source so it cannot be lost."
    ),
    longDescription:
  ...
  naev: {
    qualityBar: clearsAll(
      "Naev clears all five: free with no monetisation, mature and content-complete, actively developed, deep enough to justify a commercial price, and open-source so it cannot disappear."
    ),
    longDescription:
  ...
  "warzone-2100": {
    qualityBar: clearsAll(
      "Warzone 2100 clears all five: free with no monetisation, a complete commercial game with a full campaign, still actively maintained after being open-sourced, genuinely good on its own merits, and permanently available under GPL."
    ),
    longDescription:
  ...
  xonotic: {
    qualityBar: clearsAll(
      "Xonotic clears all five: free with no monetisation, complete and polished, still maintained, an excellent arena shooter judged on its own merits, and open-source so it cannot be shut down."
    ),
    longDescription:
  ...
  unvanquished: {
    qualityBar: clearsAll(
      "Unvanquished clears all five: free with no monetisation, complete and playable, actively developed, genuinely distinctive on its own merits, and open-source so it cannot be shut down."
    ),
    longDescription:
  ...
  "battle-for-wesnoth": {
    qualityBar: clearsAll(
      "The Battle for Wesnoth clears all five: free with no monetisation, exceptionally complete with hundreds of hours of campaigns, still maintained after two decades, better than most commercial tactics games, and open-source so it cannot be lost."
    ),
    longDescription:
  ...
  supertuxkart: {
    qualityBar: clearsAll(
      "SuperTuxKart clears all five: free with no monetisation, complete with a full campaign and multiplayer, actively developed, genuinely fun on its own merits, and open-source so it cannot be shut down."
    ),
    longDescription:
  ...
  supertux: {
    qualityBar: clearsAll(
      "SuperTux clears all five: free with no monetisation, complete with a full campaign and level editor, still maintained, genuinely enjoyable on its own merits, and open-source so it cannot be lost."
    ),
    longDescription:
  ...
  hedgewars: {
    qualityBar: clearsAll(
      "Hedgewars clears all five: free with no monetisation, complete and content-rich, still maintained after two decades, genuinely funny and good on its own merits, and open-source so it cannot be shut down."
    ),
    longDescription:
  ...
  "shattered-pixel-dungeon": {
    qualityBar: clearsAll(
      "Shattered Pixel Dungeon clears all five: free with no monetisation on desktop, complete and exceptionally well balanced, actively developed with regular releases, better than most paid roguelikes, and open-source so it cannot be lost."
    ),
    longDescription:
