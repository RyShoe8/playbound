...
export const editorial: Record<string, GameEditorial> = {
  ...
  starcraft: {
    ...
    thatOneThing:
      "Slipping six Zerglings past an unsealed ramp at minute two and watching your opponent's entire economic plan collapse in thirty seconds.",
    bestFor: [
  ...
  "tes-arena": {
    ...
    thatOneThing:
      "Crawling through a pitch-black dungeon with three hit points left, listening to monster groans behind a locked door while frantically searching for a safe room to rest.",
    bestFor: [
  ...
  daggerfall: {
    ...
    thatOneThing:
      "Taking out a massive bank loan in High Rock to buy a private sailing ship, then fleeing into a midnight thunderstorm with city guards shouting 'Halt!' behind you.",
    bestFor: [
  ...
  alephone: {
    ...
    thatOneThing:
      "Reading an AI terminal that openly mocks your loyalty mid-firefight, then dual-wielding shotguns while backpedaling through a flooded alien airlock.",
    bestFor: [
  ...
  "marathon-2": {
    ...
    whyWePickedIt:
      "Most free classics are free because nobody wanted them. Marathon 2 is free because Bungie chose to release it, and it happens to contain some of the best writing in the genre's history — an AI narrator that games spent the next twenty years imitating badly. That it now installs in one click with mouselook and widescreen, rather than requiring an emulator and a prayer, is the entire reason preservation projects matter.",
    thatOneThing:
      "Surviving a brutal alien ambush with your last magazine, only to reach a terminal where Durandal congratulates you with chilling condescension.",
    bestFor: [
      "Anyone interested in where Halo, and Bungie's writing, actually came from",
      "Players who like story delivered through reading and exploration",
      "Deliberate, resource-conscious shooting rather than constant action",
  ...
  "dungeon-keeper-gold": {
    ...
    thatOneThing:
      "Slapping your lazy imp across the dungeon floor to make him dig faster, then possessing a horned reaper in first-person to personally slaughter an invading hero party.",
    bestFor: [
  ...
  "space-station-14": {
    ...
    thatOneThing:
      "Slipping on a clown's banana peel in the hallway, getting handcuffed, and watching a rogue AI vent the entire atmospherics department into outer space.",
    bestFor: [
  ...
  freedoom: {
    ...
    thatOneThing:
      "Sprinting circles around a room packed with roaring demons, baiting them into shooting each other until you can finish the survivors with a double-barrel blast.",
    bestFor: [
  ...
  freelancer: {
    ...
    thatOneThing:
      "Dropping out of a trade lane cruise speed when hostiles jam the lane, rolling your heavy fighter through an asteroid debris field, and dogfighting four pirate gunboats in the shadows.",
    bestFor: [
  ...
  "the-ur-quan-masters": {
    ...
    thatOneThing:
      "Pitting an agile little Earthling cruiser against an immense Ur-Quan Dreadnought in a melee duel, dodging fusion blasts while plinking away with guided point-defense lasers.",
    bestFor: [
  ...
  airforce: {
    ...
    thatOneThing:
      "Bank-turning your jet fighter into a tight high-altitude loop to shake an incoming heat-seeking missile, then locking on and gun-strafing the pursuer as they overshoot.",
    bestFor: [
  ...
  bzflag: {
    ...
    thatOneThing:
      "Grabbing an oscillating phantom flag, driving straight through a solid concrete pyramid, and sniping an enemy tank from across the grid while completely invisible.",
    bestFor: [
  ...
  "beneath-a-steel-sky": {
    ...
    thatOneThing:
      "Plugging Joey's personality circuit into a succession of increasingly inappropriate robotic bodies to puzzle your way down through the grimy layers of Union City.",
    bestFor: [
  ...
  "0ad": {
    ...
    thatOneThing:
      "Sounding the town bell as cavalry raiders hit, and watching fifty farming villagers drop their baskets to draw bows and defend the granary.",
    bestFor: [
    ...
    installSteps: [{"platform":"all","text":"Install the PlayBound Launcher, then find 0 A.D. and press Install. The launcher downloads the official release and unpacks it. This is the fastest route and it never uses third-party mirrors."},{"platform":"all","text":"Alternatively, download 0 A.D. directly from the official site at https://play0ad.com. Always download from the official source — third-party mirrors of free games are a common malware vector."},{"platform":"all","text":"Official releases are published on GitHub at github.com/0ad/0ad/releases. Pick the newest stable release matching your operating system."},{"platform":"all","text":"0 A.D. is also on Steam and is free there. Open the store page and press Play Game to add it to your library.","command":"steam://install/2188200"},{"platform":"windows","text":"Run the downloaded installer and follow the prompts. If Windows SmartScreen warns about an unrecognised publisher, that is normal for open-source projects without a paid code-signing certificate — choose More info, then Run anyway."},{"platform":"macos","text":"Open the downloaded .dmg and drag the app into Applications. On first launch macOS may refuse to open it as unidentified — right-click the app and choose Open to approve it once."},{"platform":"linux","text":"Check your distribution's package manager first, which is usually the easiest route. Otherwise download the AppImage from the official site, mark it executable and run it.","command":"chmod +x *.AppImage && ./*.AppImage"},{"platform":"all","text":"Launch the game and look at the settings menu before your first session — resolution and control defaults are worth checking. 0 A.D. needs roughly 3.0 GB of free disk space."}],
    faq: [
      {
        q: "Is 0 A.D. free?",
  ...
  "beyond-all-reason": {
    ...
    thatOneThing:
      "Pulling back your view from a single commander's laser duel to watch ten thousand allied tanks clash across an entire burning continent.",
    bestFor: [
    ...
    installSteps: [{"platform":"all","text":"Install the PlayBound Launcher, then find Beyond All Reason and press Install. The launcher downloads the official release and unpacks it. This is the fastest route and it never uses third-party mirrors."},{"platform":"all","text":"Alternatively, download Beyond All Reason directly from the official site at https://www.beyondallreason.info. Always download from the official source — third-party mirrors of free games are a common malware vector."},{"platform":"windows","text":"Run the downloaded installer and follow the prompts. If Windows SmartScreen warns about an unrecognised publisher, that is normal for open-source projects without a paid code-signing certificate — choose More info, then Run anyway."},{"platform":"linux","text":"Check your distribution's package manager first, which is usually the easiest route. Otherwise download the AppImage from the official site, mark it executable and run it.","command":"chmod +x *.AppImage && ./*.AppImage"},{"platform":"all","text":"Launch the game and look at the settings menu before your first session — resolution and control defaults are worth checking. Beyond All Reason needs roughly 2.2 GB of free disk space."}],
    faq: [
      {
  ...
  "zero-k": {
    ...
    thatOneThing:
      "Drawing a single sweeping line across a mountain ridge to send twenty cliff-climbing spider bots straight over the peaks into an unguarded solar base.",
    bestFor: [
  ...
  naev: {
    ...
    thatOneThing:
      "Cutting your main thrusters to glide silently past patrol sensors, flipping 180 degrees, and unloading torpedoes into a pirate cruiser while drifting backwards.",
    bestFor: [
  ...
  "warzone-2100": {
    ...
    thatOneThing:
      "Mounting dual heavy cannons onto high-speed hover tracks and rolling a custom fleet right across the river to obliterate an enemy artillery hill.",
    bestFor: [
  ...
  unvanquished: {
    ...
    thatOneThing:
      "Lurking on the ceiling in pitch-black corridors, dropping behind an unsuspecting human marine, and biting them before their squad can turn their flashlights.",
    bestFor: [
  ...
  "battle-for-wesnoth": {
    ...
    installSteps: [{"platform":"all","text":"Install the PlayBound Launcher, then find The Battle for Wesnoth and press Install. The launcher downloads the official release and unpacks it. This is the fastest route and it never uses third-party mirrors."},{"platform":"all","text":"Alternatively, download The Battle for Wesnoth directly from the official site at https://www.wesnoth.org. Always download from the official source — third-party mirrors of free games are a common malware vector."},{"platform":"all","text":"The Battle for Wesnoth is also on Steam and is free there. Open the store page and press Play Game to add it to your library.","command":"steam://install/599390"},{"platform":"windows","text":"Run the downloaded installer and follow the prompts. If Windows SmartScreen warns about an unrecognised publisher, that is normal for open-source projects without a paid code-signing certificate — choose More info, then Run anyway."},{"platform":"macos","text":"Open the downloaded .dmg and drag the app into Applications. On first launch macOS may refuse to open it as unidentified — right-click the app and choose Open to approve it once."},{"platform":"linux","text":"Check your distribution's package manager first, which is usually the easiest route. Otherwise download the AppImage from the official site, mark it executable and run it.","command":"chmod +x *.AppImage && ./*.AppImage"},{"platform":"all","text":"Launch the game and look at the settings menu before your first session — resolution and control defaults are worth checking. The Battle for Wesnoth needs roughly 700 MB of free disk space."}],
    faq: [
      {
  ...
  supertuxkart: {
    ...
    thatOneThing:
      "Hitting a bowling bomb trick shot off a tight wall bounce to steal first place from your friend right at the finish line.",
    bestFor: [
  ...
  supertux: {
    ...
    thatOneThing:
      "Sliding across frictionless ice at full speed, bouncing off a snowball enemy, and clearing a bottomless spike pit with zero traction.",
    bestFor: [
  ...
  hedgewars: {
    ...
    thatOneThing:
      "Launching an exploding sheep in high wind across the entire map, watching it ricochet off a bouncy mine, and blasting your friend's hedgehog into the sea.",
    bestFor: [
  ...
  veloren: {
    ...
    thatOneThing:
      "Gliding off a snow-capped mountain peak at sunset, soaring through cloud banks, and landing right at the entrance of a glowing subterranean dungeon.",
    bestFor: [
    ...
    installSteps: [{"platform":"all","text":"Install the PlayBound Launcher, then find Veloren and press Install. The launcher downloads the official release and unpacks it. This is the fastest route and it never uses third-party mirrors."},{"platform":"all","text":"Alternatively, download Veloren directly from the official site at https://veloren.net. Always download from the official source — third-party mirrors of free games are a common malware vector."},{"platform":"all","text":"Official releases are published on GitHub at github.com/veloren/veloren/releases. Pick the newest stable release matching your operating system."},{"platform":"all","text":"Veloren is also on Steam and is free there. Open the store page and press Play Game to add it to your library.","command":"steam://install/1687530"},{"platform":"windows","text":"Run the downloaded installer and follow the prompts. If Windows SmartScreen warns about an unrecognised publisher, that is normal for open-source projects without a paid code-signing certificate — choose More info, then Run anyway."},{"platform":"macos","text":"Open the downloaded .dmg and drag the app into Applications. On first launch macOS may refuse to open it as unidentified — right-click the app and choose Open to approve it once."},{"platform":"linux","text":"Check your distribution's package manager first, which is usually the easiest route. Otherwise download the AppImage from the official site, mark it executable and run it.","command":"chmod +x *.AppImage && ./*.AppImage"},{"platform":"all","text":"Launch the game and look at the settings menu before your first session — resolution and control defaults are worth checking. Veloren needs roughly 1.6 GB of free disk space."}],
    faq: [
      {
        q: "Is Veloren free?",
  ...
  everquest: {
    ...
    thatOneThing:
      "Sitting in the pitch-black Oasis of Marr at 2 AM, hearing someone scream 'TRAIN TO ZONE!' and frantically sprinting for the boundary line.",
    bestFor: [
  ...
  flightgear: {
    ...
    thatOneThing:
      "Breaking through zero-visibility cloud cover in a crosswind storm and catching the glowing runway lights just seconds before wheels touch down.",
    bestFor: [
  ...
  freeciv: {
    ...
    thatOneThing:
      "Sailing an unescorted transport ship past an enemy patrol and landing cavalry outside their undefended capital the exact second the turn timer expires.",
    bestFor: [
  ...
  openciv3: {
    ...
    thatOneThing:
      "Building a Great Wonder on your border and watching your rival's heavily garrisoned frontier city willingly defect to your empire.",
    bestFor: [
  ...
  "asphalt-legends": {
    ...
    thatOneThing:
      "Hitting a nitro shockwave off a high-altitude ramp, executing a 360-degree flat spin in mid-air, and barrel-rolling across the finish line.",
    bestFor: [
  ...
  "tinywind-pixel-pirate-sailing-game": {
    ...
    thatOneThing:
      "Catching a sudden tailwind across a stormy pixel ocean, angling your broadside cannons, and sinking a rival pirate galleon with a single well-aimed volley.",
    bestFor: [
  ...
  warframe: {
    ...
    thatOneThing:
      "Bullet-jumping through a ventilation shaft, drawing an energy bow mid-somersault, and pinning an entire squad of Grineer soldiers to the wall in slow motion.",
    bestFor: [
  ...
  "mega-man-unlimited": {
    ...
    thatOneThing:
      "Sliding under a screen-filling boss laser with one sliver of health left and charging your Buster shot to deliver the final killing blow.",
    bestFor: [
  ...
  triplea: {
    ...
    thatOneThing:
      "Rolling a fistful of dice for a massive amphibious D-Day landing, watching your lone surviving battleship roll a six, and securing the Normandy beachhead.",
    bestFor: [
  ...
  "gradius-remake": {
    ...
    thatOneThing:
      "Weaving your needle-thin Vic Viper through a wall of blue laser rings with zero shields left, relying purely on split-second muscle memory.",
    bestFor: [
  ...
  "team-fortress-2": {
    ...
    thatOneThing:
      "Rocket-jumping across the entire skybox, landing behind enemy lines, and one-shotting the enemy Medic with a market gardener shovel before touching the ground.",
    longDescription:
  ...
  "wolfenstein-enemy-territory": {
    ...
    thatOneThing:
      "Planting the dynamite on the Gold Rush bank vault doors with twenty seconds on the clock while your field ops teammate calls in an airstrike on the incoming Allied defense.",
    longDescription:
  ...
  "asherons-call": {
    ...
    thatOneThing:
      "Kiting an Olthoi Queen across miles of rolling hills while frantically re-buffing your spell duration timers before your mana runs dry.",
    longDescription:
  ...
  "counter-strike-2": {
    ...
    thatOneThing:
      "Blowing a hole right through a dense smoke grenade with an HE blast to headshot the AWPer who thought they were safe on the other side.",
    longDescription:
  ...
  valorant: {
    ...
    thatOneThing:
      "Hearing the spike defuse tap, flashing through a solid concrete wall, and snapping a 1v3 clutch with three clean Vandal headshots.",
    longDescription:
  ...
  "war-thunder": {
    ...
    thatOneThing:
      "Diving out of the sun at 500 km/h in an unguided dive-bomber, dropping a 500kg bomb directly onto an enemy tank's engine deck, and pulling high-G flaps to avoid the trees.",
    longDescription:
  ...
  "star-wars-galaxies": {
    ...
    thatOneThing:
      "Setting up a moisture vaporator camp in the Dune Sea of Tatooine under twin suns, then resting around a campfire while an entertainer buffs your combat mind pool.",
    longDescription:
  ...
  "gamebuddies-io": {
    ...
    thatOneThing:
      "Chaining lightning-fast party minigames in a shared lobby where one bad bounce or accidental misclick triggers absolute chaos on voice chat.",
    longDescription:
  ...
  pixreveal: {
    ...
    thatOneThing:
      "Racing against friends in a real-time pixel grid where clearing the final mystery block reveals the hidden picture a split second before anyone else.",
    longDescription:
  ...
  "world-of-sea-battle": {
    ...
    thatOneThing:
      "Maneuvering a four-deck ship-of-the-line through rolling ocean swells, waiting for the ship to roll on the crest, and firing a sixty-gun broadside that snaps the enemy mast in two.",
    longDescription:
  ...
  "old-school-runescape": {
    ...
    thatOneThing:
      "Standing in the Wilderness with your best gear on the line, timing a prayer switch against a barrage, and hitting a 73 with an Armadyl Godsword special.",
    longDescription:
  ...
  "star-wars-the-old-republic": {
    ...
    thatOneThing:
      "Force-leaping across an abyssal chasm as a Sith Warrior, interrupting an enemy orbital strike, and turning the tide of an eight-man raid boss fight.",
    longDescription:
  ...
  mrboom: {
    ...
    thatOneThing:
      "Trapping three of your friends in a dead-end corridor with a remote-detonated bomb chain, then accidentally grabbing a skull curse that reverses your own controls.",
    bestFor: [
  ...
  openmohaa: {
    ...
    thatOneThing:
      "Storming Omaha Beach under deafening machine-gun fire, diving behind an anti-tank hedgehog, and sniping the bunker gunner through the concrete embrasure.",
    longDescription:
  ...
  "metal-slug-remake": {
    ...
    thatOneThing:
      "Jumping into a battered tankette, bouncing over landmines while spraying heavy machine gun fire, and watching half the screen erupt in hand-drawn explosions.",
    longDescription:
  ...
  brawlhalla: {
    ...
    thatOneThing:
      "Chucking your unarmed heavy hammer off the stage edge to snipe an opponent trying to recover, then ground-pounding them into the abyss.",
    bestFor: [
  ...
  "cataclysm-dda": {
    ...
    thatOneThing:
      "Welding solar panels and heavy spiked ram-plows onto an old ice cream truck to blast through a horde of skeletal juggernauts.",
    bestFor: [
  ...
  yorg: {
    ...
    thatOneThing:
      "Drifting a high-performance open-wheel racer around a banked gravel bend at ninety miles per hour while kicking up rooster tails of dust into your opponent's windshield.",
    bestFor: [
  ...
  torcs: {
    ...
    thatOneThing:
      "Drafting bumper-to-bumper behind a rival sports car at top speed, braking a split-second later into a hairpin chicane, and threading the inside curb to steal the podium.",
    bestFor: [
  ...
  "stunt-rally": {
    ...
    thatOneThing:
      "Hitting a corkscrew loop on an alien planet track at 150 miles per hour, firing your jump jet boost, and sticking a four-wheel landing on a razor-thin suspension bridge.",
    bestFor: [
  ...
  srb2: {
    ...
    thatOneThing:
      "Spin-dashing up a sheer canyon wall at Mach speed, uncurling mid-air, and chaining homing attacks across floating badniks to hit the upper secret route.",
    bestFor: [
  ...
  jfsw: {
    ...
    thatOneThing:
      "Slicing a demon ninja clean in half with your katana, then pulling out a nuclear missile launcher to level an entire courtyard.",
    bestFor: [
