...
export const editorial: Record<string, GameEditorial> = {
  ...
  "stalker-anomaly": {
    ...
    installSteps: [
      ...
      { platform: "windows", text: "Optional: for G.A.M.M.A., select the GAMMA edition and follow the official GitHub Installing-GAMMA wiki after Anomaly works." },
    ],
    faq: [
      ...
      { q: "What is GAMMA?", a: "G.A.M.M.A. is an optional hardcore survival modpack for Anomaly (Grok's Automated Modular Modpack). PlayBound lists it as the GAMMA edition under Anomaly — install clean Anomaly first." },
