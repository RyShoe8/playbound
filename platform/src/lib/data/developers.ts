...
export const developers: Developer[] = [
  ...
  },
  {
    ...
    about: "The British strategy studio behind Stronghold and its long-running castle-simulation series.",
    founded: 1999,
    location: "London, United Kingdom",
    website: "https://fireflyworlds.com/",
    artHue: 24,
  },
  {
    slug: "gsc-game-world",
    name: "GSC Game World",
    tagline: "Creators of the Zone.",
    about: "The Ukrainian studio behind S.T.A.L.K.E.R. and Cossacks.",
    founded: 1995,
  ...
  },
  {
    slug: "bioware",
    name: "BioWare",
    tagline: "Character-led role-playing worlds.",
    about: "The role-playing studio behind Knights of the Old Republic, Baldur's Gate, Mass Effect, and Dragon Age.",
    founded: 1995,
  ...
  },
  {
    ...
    tagline: "Role-playing games with difficult questions.",
    about: "The RPG studio behind Knights of the Old Republic II, Fallout: New Vegas, Pillars of Eternity, and The Outer Worlds.",
    founded: 2003,
  ...
  },
  {
    ...
    tagline: "The studio that taught worlds to notice the player.",
    about: "The influential immersive-sim studio behind Thief, System Shock, and Ultima Underworld.",
    founded: 1990,
  ...
  {
    slug: "new-world-computing",
    name: "New World Computing",
    tagline: "Masters of turn-based fantasy strategy and role-playing adventures.",
    about: "The legendary American game development studio best known for creating the Heroes of Might and Magic series and the Might and Magic RPGs.",
    founded: 1984,
  ...
  },
  {
    ...
    tagline: "Pioneers of tactical 3D real-time strategy.",
    about: "The Swedish game development studio that redefined real-time strategy with the groundbreaking Ground Control and World in Conflict series.",
    founded: 1997,
  ...
  {
    slug: "aleph-one",
    name: "Aleph One Developers",
    tagline: "Preserving and modernizing Bungie's classic Marathon trilogy.",
    about: "The open-source community dedicated to maintaining, enhancing, and porting Bungie's seminal Marathon game engine to modern platforms.",
    founded: 2000,
  ...
  },
  {
    slug: "eric-froemling",
    name: "Eric Froemling",
    tagline: "Creator of the explosive party game BombSquad.",
    about: "Independent game developer and creator of BombSquad, the hilarious local and online multiplayer combat game.",
    founded: 2011,
    location: "United States",
  ...
  {
    slug: "huki-jiggeh",
    name: "Huki & Jiggeh (RVGL Team)",
    tagline: "Revitalizing the classic RC racer Re-Volt for modern hardware.",
    about: "The dedicated development team behind RVGL, an advanced cross-platform rewrite and modernization of Acclaim's 1999 RC racing classic Re-Volt.",
    founded: 2015,
    location: "Open Source",
  ...
  {
    slug: "phoboslab",
    name: "PhobosLab (Dominic Szablewski)",
    tagline: "Retro game preservation, source ports, and web game technology.",
    about: "Dominic Szablewski, creator of high-profile game preservation projects including the wipEout Rewrite and the Impact game engine.",
    founded: 2010,
    location: "Germany",
  ...
  },
  {
    slug: "openhv-team",
    name: "OpenHV Team",
    tagline: "Pixel-art sci-fi real-time strategy powered by OpenRA.",
    about: "The indie community developing OpenHV, an original retro sci-fi real-time strategy game built on the open-source OpenRA engine.",
    founded: 2018,
    location: "Open Source",
  ...
  },
  {
    slug: "cleverraven",
    name: "CleverRaven",
    tagline: "Surviving the apocalypse, one turn at a time.",
    about: "The open-source community behind Cataclysm: Dark Days Ahead (CDDA), one of the deepest and most expansive post-apocalyptic survival roguelikes ever made.",
    founded: 2013,
    location: "Open Source",
  ...
  },
  {
    slug: "ya2",
    name: "Ya2",
    tagline: "Indie games, procedural worlds, and vehicular combat.",
    about: "Flavio Calva, creator of YORG (Yorg's an Open Racing Game), crafting fast-paced open-source 3D arcade racing games.",
    founded: 2017,
    location: "Italy",
  ...
  {
    slug: "torcs-team",
    name: "TORCS Development Team",
    tagline: "Open-source 3D racing simulation and AI testbed.",
    about: "The international community maintaining TORCS (The Open Racing Car Simulator), the premier modular multi-platform car racing simulation.",
    founded: 1997,
    location: "Open Source",
  ...
  },
  {
    slug: "cryham",
    name: "CryHam",
    tagline: "High-flying stunt racing across varied terrain.",
    about: "Independent creator and maintainer of Stunt Rally, an open-source 3D stunt racing game with track editor and advanced physics.",
    founded: 2010,
    location: "Poland",
  ...
  {
    slug: "jonof",
    name: "JonoF (Jonathan Fowler)",
    tagline: "Pioneering Build engine source ports.",
    about: "Jonathan Fowler, pioneering developer behind JFDuke3D and JFSW, the foundational OpenGL-enhanced source ports for Build engine classics.",
    founded: 2002,
    location: "Australia",
  ...
  {
    slug: "ensemble-studios",
    name: "Ensemble Studios",
    tagline: "Architects of history's greatest real-time strategy empires.",
    about: "The legendary Microsoft-owned studio behind the Age of Empires series, Age of Mythology, and Star Wars: Galactic Battlegrounds.",
    founded: 1995,
