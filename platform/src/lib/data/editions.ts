...
export const editions: EditionSeed[] = [
  ...
  },
  {
    ...
    installConfig: {
      playbound_installer: {
        ...
        assetPattern: ".*\\.zip$",
        exeHint: "acclient.exe",
        note: "Configured for Dekarutide custom ARPG server.",
      },
    },
    features: ["Multiplayer", "Dedicated Servers", "Mod Support", "Open World"],
  ...
  },
  {
    ...
    slug: "steam",
    name: "Steam Edition (Default)",
    shortDescription: "Official Steam release with automatic updates and full controller support.",
    description:
      "The official Steam release of Mr. Boom. Supports 8 simultaneous controllers, netplay, AI bots, and Steam Deck integration.",
    type: "official",
    isDefault: true,
    sortOrder: 10,
    links: {
  ...
  },
  {
    gameSlug: "mrboom",
    slug: "standalone",
    name: "Standalone Release Edition",
    shortDescription: "Portable DRM-free open-source build for PC.",
    description:
      "Standalone open-source binary for Mr. Boom. Lightweight and portable with zero installation dependencies.",
    type: "official",
    isDefault: false,
    sortOrder: 20,
    links: {
    ...
    features: ["Multiplayer", "Local Co-Op", "Portable", "DRM-Free"],
    tags: ["Standalone", "Open Source", "Party"],
    aliases: ["Mr. Boom Standalone"],
    verificationLevel: "playbound_verified",
  },
  {
    gameSlug: "openmohaa",
