...
export const editions: EditionSeed[] = [
  ...
  },
  {
    ...
    slug: "phantom-edition",
    name: "wipEout Phantom Edition (Default)",
    shortDescription: "Enhanced 64-bit PC port with high-framerate support, widescreen 4K rendering, and modern gamepads.",
    description:
      "The definitive modern PC release of the 1995 futuristic racing classic. Features unconstrained framerates, native high-resolution rendering, refined collision physics, and plug-and-play controller support.",
    type: "community",
    status: "active",
    visibility: "public",
    isDefault: true,
    sortOrder: 10,
    links: {
      website: "https://github.com/wipeout-phantom-edition/wipeout-phantom-edition",
      github: "https://github.com/wipeout-phantom-edition/wipeout-phantom-edition",
    },
    installMethod: "playbound_installer",
    installConfig: {
      playbound_installer: {
        ...
        exeHint: "wipeout",
        note: "Enhanced 64-bit WipEout port.",
      },
    },
    requirements: {
      min: "1.0 GHz CPU / 512 MB RAM / OpenGL 3.3 / 100 MB storage",
      recommended: "Dual-Core CPU / 2 GB RAM / Dedicated GPU / USB Gamepad",
    },
    features: ["Singleplayer", "Multiplayer", "Controller Support", "Split-Screen", "High Framerate"],
    tags: ["Anti-Gravity", "Racing", "Sci-Fi", "Classic", "Combat Racing"],
    aliases: ["Wipeout Phantom Edition", "WipEout PC", "Wipeout Rewrite"],
    version: "1.2.256",
    verificationLevel: "community_verified",
  },
  {
