...
export const editions: EditionSeed[] = [
  ...
  },
  {
    ...
    version: "1.5.3",
    shortDescription: "The whole trilogy's Zone reshaped into a free-roaming survival sandbox.",
    description:
      "Anomaly is the great open-ended Zone: every major region, faction starts, story routes, and enough tuning to make the same road feel different twice. Standalone ModDB install — no Call of Pripyat GOG copy required.",
    type: "official",
    status: "active",
    visibility: "public",
    isDefault: true,
    ...
    aliases: ["STALKER Anomaly", "Anomaly"],
    verificationLevel: "community_verified",
    requirements: {
  ...
  },
  {
    ...
    shortDescription: "DRM-free GOG release of S.T.A.L.K.E.R.: Clear Sky.",
    description:
      "The official Clear Sky master from GOG. Install the DRM-free offline installer from your GOG library and play.",
    type: "official",
    status: "active",
    visibility: "public",
    isDefault: true,
  ...
  },
  {
    ...
    description:
      "Lost Alpha imagines the game Shadow of Chornobyl might have become before years of cuts reshaped it: wider maps, restored ideas, new routes, and its own campaign. Standalone — no Shadow of Chornobyl GOG install required; install from ModDB as its own folder.",
    type: "community",
    status: "active",
    visibility: "public",
    isDefault: false,
  ...
  },
  {
    ...
    description:
      "True Stalker is a complete standalone story with its own protagonist, quests, performances, and carefully rebuilt spaces. Standalone — no Shadow of Chornobyl GOG install required.",
    type: "community",
    status: "active",
    visibility: "public",
    isDefault: false,
