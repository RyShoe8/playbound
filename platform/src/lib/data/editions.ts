...
export const editions: EditionSeed[] = [
  ...
  },
  {
    ...
    shortDescription: "The complete original game at modern resolutions, with HD+'s living online lobby and PlayBound party support.",
    description:
      "The PlayBound way to play Heroes III Complete with friends. HD Mod leaves the original campaigns and balance intact while adding modern resolutions, interface improvements, bug fixes, and the HD+ online lobby. PlayBound parties can use that public community lobby or switch to PlayBound Connect for a private shared network without port forwarding.",
    type: "community",
    status: "active",
    visibility: "public",
    isDefault: true,
    ...
    links: {
      ...
      wiki: "https://sites.google.com/site/heroes3hd/eng/description",
    },
    installMethod: "playbound_installer",
    installConfig: {
      playbound_installer: {
        kind: "direct-installer",
        url: "https://heroes3hd.com/HoMM3_HD_Latest_setup.exe",
        fileName: "HoMM3_HD_Latest_setup.exe",
        versionLabel: "latest",
        exeHint: "HD_Launcher",
        knownExePaths: [
          "%PROGRAMFILES(X86)%\\GOG Galaxy\\Games\\HoMM 3 Complete\\HD_Launcher.exe",
          "%PROGRAMFILES%\\GOG Galaxy\\Games\\HoMM 3 Complete\\HD_Launcher.exe",
          "C:\\GOG Games\\HoMM 3 Complete\\HD_Launcher.exe",
          "HD_Launcher.exe",
        ],
        note: "Requires Heroes III Complete. PlayBound downloads the official HD Mod installer; confirm the existing GOG game folder once, then launch through HD_Launcher.",
        steps: [
          { platform: "windows", text: "Install your DRM-free Heroes III Complete copy from GOG first." },
          { platform: "windows", text: "Click Install with PlayBound. In the official HD Mod installer, confirm the Heroes III Complete folder." },
          { platform: "windows", text: "Create or join the HD+ Online Lobby from HD_Launcher, or let PlayBound Connect place the party on one private network for LAN play." },
        ],
      },
    },
    features: ["Singleplayer", "Multiplayer", "Online Lobby", "LAN", "Hotseat", "PlayBound Connect", "High Resolution", "Mod Support"],
    tags: ["HD Mod", "HD+", "Community Lobby", "Private Party", "No Steam"],
    aliases: ["Heroes 3 HD Mod", "HoMM3 HD+", "Lobby HD"],
    verificationLevel: "community_verified",
    verificationNote: "Official HD Mod site confirms full Heroes III Complete compatibility and HD+ Online Lobby support.",
  },
  {
    gameSlug: "ground-control-anthology",
    slug: "playbound-connect",
    name: "Ground Control — PlayBound Connect Edition",
    shortDescription: "The complete GOG Anthology with its surviving eight-player LAN mode carried across the internet.",
    description:
      "WON.net is gone, but Ground Control's LAN game still works. This edition keeps the DRM-free GOG build untouched and uses PlayBound Connect to put the whole party on one private network. The leader creates a LAN game, everyone else joins from the game's LAN list, and nobody opens a router port.",
    type: "community",
    status: "active",
    visibility: "public",
    isDefault: true,
    ...
    links: {
      ...
      wiki: "https://shared.steamstatic.com/store_item_assets/steam/apps/254820/manuals/Ground_Control_Anthology_Manual.pdf?t=1579791410",
    },
    installMethod: "playbound_installer",
    installConfig: {
      playbound_installer: {
        ...
        note: "Install the DRM-free GOG build, then PlayBound locates gc.exe and supplies the private party network.",
        steps: [
          { platform: "windows", text: "Install Ground Control Anthology with GOG's offline installer; Galaxy is not required." },
          { platform: "windows", text: "Join the PlayBound party and choose PlayBound Connect — host locally." },
          { platform: "windows", text: "Leader: create a LAN game. Everyone else: open LAN and join the leader's session." },
        ],
      },
    },
    features: ["Singleplayer", "Multiplayer", "LAN", "Co-op", "PlayBound Connect"],
    tags: ["Virtual LAN", "Private Party", "Eight Players", "No Port Forwarding", "No Steam"],
    aliases: ["Ground Control Connect", "Ground Control LAN Edition"],
    verificationLevel: "community_verified",
    verificationNote: "The original manual documents LAN hosting; current storefront notices confirm public Internet play is gone while LAN remains.",
  },
  {
    gameSlug: "ground-control-2-operation-exodus",
    slug: "playbound-essentials",
    name: "Ground Control 2: PlayBound Essentials",
    shortDescription: "Modern widescreen and launch fixes, OpenSpy multiplayer, and a private PlayBound Connect fallback.",
    description:
      "PlayBound copies your legal GOG installation, then layers GC2 Essentials over the copy. The current community pack fixes wireless-device launch failures, improves zoom, repairs 16:9 presentation, and replaces the dead GameSpy backend with OpenSpy. Public community games work again, while PlayBound Connect keeps LAN hosting available for private parties.",
    type: "community",
    status: "active",
    visibility: "public",
    isDefault: true,
    sortOrder: 10,
    links: {
      website: "https://gc2.mkla.dev/",
      github: "https://github.com/Vegasq/gc2patch",
      wiki: "https://shared.fastly.steamstatic.com/store_item_assets/steam/apps/254840/manuals/Ground_Control_II_Manual.pdf?t=1579791420",
    },
    installMethod: "playbound_installer",
    installConfig: {
      playbound_installer: {
        ...
        overlayUrl: "https://github.com/Vegasq/gc2patch/releases/download/2026.01.02/GC2Essentials_2026.01.02.zip",
        overlayFileName: "GC2Essentials_2026.01.02.zip",
        checksumMd5: "610b30b6f7f45c016ae47e6fc7ad9bfd",
        versionLabel: "2026.01.02",
        exeHint: "gcii",
        knownExePaths: ["gcii.exe"],
        note: "Requires a legal GOG or Steam 1.0.0.8 install. PlayBound copies it and overlays GC2 Essentials; your original stays untouched.",
        steps: [
          { platform: "windows", text: "Install Ground Control 2 version 1.0.0.8 from your GOG offline installer." },
          { platform: "windows", text: "Click Install with PlayBound and select the folder containing gcii.exe. PlayBound copies it, then applies GC2 Essentials." },
          { platform: "windows", text: "Use OpenSpy for public online games, or choose PlayBound Connect and use the LAN menu for a private party." },
        ],
      },
    },
    features: ["Singleplayer", "Multiplayer", "Online Multiplayer", "LAN", "Three-Player Co-op", "PlayBound Connect", "Widescreen Support", "Community Fixes"],
    tags: ["GC2 Essentials", "OpenSpy", "Virtual LAN", "Eight Players", "No Steam"],
    aliases: ["GC2 Essentials", "Ground Control II OpenSpy", "GC2 PlayBound Edition"],
    verificationLevel: "community_verified",
  ...
  },
  {
    ...
    features: ["Singleplayer", "Multiplayer", "LAN Support", "Mod Support", "Custom Maps", "Community Content", "Team Play"], tags: ["Classic", "Competitive", "LAN", "Mods"], aliases: ["UCP3", "Unofficial Crusader Patch"], verificationLevel: "community_verified",
  },
  {
  ...
  },
  {
    ...
    shortDescription: "DRM-free GOG release of S.T.A.L.K.E.R.: Call of Pripyat — the official trilogy finale.",
    description:
      "The official Call of Pripyat master from GOG: Major Degtyarev, three broad regions, and the campaign's consequential side quests. Install the DRM-free offline installer from your GOG library. Free standalones (Anomaly, GAMMA) are separate catalog entries — do not overwrite this folder with those packs.",
    type: "official",
    status: "active",
    visibility: "public",
    isDefault: true,
  ...
  {
    gameSlug: "stalker-anomaly",
    slug: "official",
    name: "Anomaly — Standalone (Default)",
    version: "1.5.3",
    shortDescription:
      "Free standalone — no trilogy GOG install required. The whole Zone as a free-roaming survival sandbox.",
    description:
      "Anomaly is the great open-ended Zone: every major region, faction starts, story routes, economy and difficulty tuning deep enough that the same road feels different twice. Standalone ModDB package — no Call of Pripyat or Shadow of Chornobyl GOG copy required. Launch AnomalyLauncher once and confirm a save works before installing the optional GAMMA edition.",
    type: "official",
    status: "active",
    visibility: "public",
    isDefault: true,
    ...
    tags: ["Open World", "Mods", "Survival"],
    aliases: ["STALKER Anomaly", "Anomaly", "Anomaly 1.5.3"],
    verificationLevel: "community_verified",
    requirements: {
      min: "Windows 7 · Dual-core CPU · 4 GB RAM · DX9 GPU · 10 GB storage",
      recommended: "Windows 10 · Quad-core · 8 GB RAM · DX11 GPU · 20 GB storage",
    },
    hardwareRequirements: {
      min: {
        ...
        cpuTier: "mid",
        gpuTier: "entry",
        notes: "Standalone Anomaly build; large install",
      },
      recommended: {
        ramMB: 8192,
        storageMB: 20480,
        ...
        gpuText: "DirectX 11 dedicated GPU",
        cpuTier: "mid",
        gpuTier: "mid",
        notes: "Standalone Anomaly build; large install",
      },
      provenance: { source: "playbound_verified" },
    },
  },
  {
    gameSlug: "stalker-anomaly",
    ...
    hardwareRequirements: {
      min: {
        ...
        apis: ["dx11"],
        cpuText: "Quad-core CPU",
        gpuText: "DirectX 11 dedicated GPU (GTX 1650 / RX 470 class)",
        cpuTier: "mid",
        gpuTier: "mid",
        notes: "Requires Anomaly first; GAMMA launcher pulls many addons",
      },
      recommended: {
        ramMB: 16384,
        storageMB: 133120,
        apis: ["dx11"],
        cpuText: "Modern hex/octa-core",
        gpuText: "Dedicated mid-range DX11+ GPU",
        cpuTier: "high",
        gpuTier: "mid",
        notes: "SSD strongly preferred for MO2 + large addon set",
      },
      provenance: { source: "playbound_verified", verifiedAt: "2026-09-13" },
    },
  },
  {
    gameSlug: "s-t-a-l-k-e-r-clear-sky",
    slug: "official",
    name: "Clear Sky — GOG Master (Default)",
    shortDescription: "DRM-free GOG release of S.T.A.L.K.E.R.: Clear Sky — the trilogy prequel.",
    description:
      "The official Clear Sky master from GOG: Scar, faction wars, and emissions between Shadow of Chornobyl and Call of Pripyat. Install the DRM-free offline installer from your GOG library. Does not require owning the other trilogy games.",
    type: "official",
    status: "active",
    visibility: "public",
    isDefault: true,
    sortOrder: 5,
    links: { website: "https://www.gog.com/en/game/stalker_clear_sky" },
    installMethod: "official_download",
    installConfig: {
      official_download: {
    ...
    features: ["Singleplayer", "Multiplayer", "LAN Support", "Dedicated Servers", "Mod Support", "Community Content", "Story Campaign"],
    tags: ["Open World", "Classic", "Mods"],
    aliases: ["STALKER Clear Sky GOG", "Clear Sky Official"],
    verificationLevel: "official",
  },
  {
    ...
    shortDescription: "DRM-free GOG release of S.T.A.L.K.E.R.: Shadow of Chornobyl — the original Zone.",
    description:
      "The official Shadow of Chornobyl master from GOG. Default Install opens the commercial DRM-free campaign. Lost Alpha and True Stalker stay as separate standalone editions so Install never points at ModDB by default.",
    type: "official",
    status: "active",
    visibility: "public",
    isDefault: true,
  ...
  },
  {
    ...
    version: "1.4007",
    shortDescription:
      "Standalone — no Shadow of Chornobyl GOG install required. The abandoned early vision rebuilt into a huge journey.",
    description:
      "Lost Alpha Developer's Cut imagines the game Shadow of Chornobyl might have become before years of cuts reshaped it: wider maps, restored ideas, new routes, and its own campaign. Standalone ModDB install into its own folder — no GOG Shadow of Chornobyl copy required. PlayBound launches bins\\XR_3DA.exe; use Lost Alpha Configurator once for graphics if needed.",
    type: "community",
    status: "active",
    visibility: "public",
    isDefault: false,
    ...
    installConfig: {
      playbound_installer: {
        ...
        note:
          "Standalone ModDB install — no Shadow of Chornobyl GOG copy required. PlayBound launches bins\\XR_3DA.exe — use Lost Alpha Configurator once for graphics if you need it; Play does not open that tweaker.",
      },
    },
    features: ["Singleplayer", "Mod Support", "Community Content", "Story Campaign"],
    tags: ["Open World", "Mods"],
    aliases: ["STALKER Lost Alpha", "Lost Alpha DC", "Lost Alpha Developer's Cut"],
    verificationLevel: "community_verified",
    requirements: {
      min: "Windows 7 · Dual-core · 2 GB RAM · DX9 GPU · ~10 GB storage",
      recommended: "Windows 10 · Quad-core · 4 GB RAM · Dedicated GPU · ~12 GB storage",
    },
    hardwareRequirements: {
      min: {
        ramMB: 2048,
        ...
        cpuTier: "entry",
        gpuTier: "entry",
        notes: "Standalone Lost Alpha DC; no SoC GOG required",
      },
      recommended: {
        ramMB: 4096,
        storageMB: 12288,
        apis: ["dx9"],
        cpuText: "Quad-core CPU",
        gpuText: "Dedicated DirectX 9 GPU",
        cpuTier: "mid",
        gpuTier: "low",
      },
      provenance: { source: "playbound_verified", verifiedAt: "2026-09-13" },
  ...
  },
  {
    gameSlug: "s-t-a-l-k-e-r-shadow-of-chernobyl",
    slug: "true-stalker",
    name: "True Stalker — Standalone",
    version: "1.5",
    shortDescription:
      "Standalone — no Shadow of Chornobyl GOG install required. A polished fan-made campaign in a familiar Zone.",
    description:
      "True Stalker is a complete standalone story with its own protagonist, quests, performances, and carefully rebuilt spaces. Install from ModDB into its own folder — no Shadow of Chornobyl GOG purchase or install is required. Keep it separate from the GOG master and from Lost Alpha.",
    type: "community",
    status: "active",
    visibility: "public",
    isDefault: false,
    ...
    installMethod: "external_installer",
    installConfig: { external_installer: { url: "https://www.moddb.com/mods/true-stalker" } },
    features: ["Singleplayer", "Mod Support", "Community Content", "Story Campaign"],
    tags: ["Open World", "Mods"],
    aliases: ["True Stalker", "STALKER True Stalker"],
    verificationLevel: "community_verified",
    requirements: {
      min: "Windows 7 · Dual-core · 2 GB RAM · DX9 GPU · ~8 GB storage",
      recommended: "Windows 10 · Quad-core · 4 GB RAM · Dedicated GPU",
    },
    hardwareRequirements: {
      min: {
        ramMB: 2048,
        ...
        cpuTier: "entry",
        gpuTier: "entry",
        notes: "Standalone True Stalker; no SoC GOG required",
      },
      recommended: {
        ramMB: 4096,
        storageMB: 10240,
  ...
  },
  {
    ...
    shortDescription: "A full companion-driven campaign woven through KOTOR's galaxy.", description: "Brotherhood of Shadow is another RPG tucked inside the first one: new companions, planets, voiced scenes, and a long narrative crossing the main campaign.", type: "community", status: "active", visibility: "public", sortOrder: 20, links: { website: "https://deadlystream.com/files/file/761-brotherhood-of-shadow-solomons-revenge/" }, installMethod: "external_installer", installConfig: { external_installer: { url: "https://deadlystream.com/files/file/761-brotherhood-of-shadow-solomons-revenge/" } }, features: ["Singleplayer", "Mod Support", "Community Content", "Story Campaign"], tags: ["Classic", "Mods", "Sci-Fi"], aliases: ["BOSSR"], verificationLevel: "community_verified",
  },
  {
    ...
    shortDescription: "The missing connective tissue, character scenes, and ending work restored to KOTOR II.", description: "TSLRCM is the closest thing KOTOR II has to a director's cut, restoring quests, companion material, combat sequences, and the connective scenes that help the final act breathe.", type: "community", status: "active", visibility: "public", sortOrder: 10, links: { website: "https://deadlystream.com/files/file/578-tsl-restored-content-mod/" }, installMethod: "external_installer", installConfig: { external_installer: { url: "https://deadlystream.com/files/file/578-tsl-restored-content-mod/" } }, features: ["Singleplayer", "Mod Support", "Community Content", "Story Campaign"], tags: ["Classic", "Mods", "Sci-Fi"], aliases: ["TSLRCM"], verificationLevel: "community_verified",
  },
  {
  ...
  },
  {
    ...
    links: {
      ...
      forum: "https://zandronum.com/forum/",
    },
    installMethod: "playbound_installer",
    installConfig: {
      playbound_installer: {
        ...
        note: "Bundles Zandronum 3.2.1 64-bit multiplayer engine with official Freedoom IWADs.",
      },
    },
    features: [
      "Multiplayer",
    ...
    tags: ["Multiplayer", "Co-op", "PvP", "Retro FPS", "Zandronum", "Boomer Shooter", "Controller Support"],
    aliases: ["Freedoom Zandronum", "Zandronum", "Freedoom Multiplayer"],
    verificationLevel: "playbound_verified",
  },
  {
    gameSlug: "freedoom",
  ...
  },
  {
    ...
    tags: ["Space Sim", "RTS", "Open Source"],
  ...
  // --- Marathon 2 / Aleph One ---
  {
    ...
    shortDescription: "Bungie's 1995 sequel in Aleph One with high-definition XBLA textures and remastered audio.",
    description:
      "Bungie's 1995 sequel remastered on the open-source Aleph One engine with high-resolution Xbox Live Arcade (XBLA) textures, enhanced sprites, 60fps mouselook, and native controller support.",
    type: "official",
    status: "active",
    visibility: "public",
    isDefault: true,
    ...
    installConfig: {
      playbound_installer: {
        ...
        note: "Includes the Aleph One engine, complete Marathon 2 scenario, and high-definition XBLA graphical replacements.",
      },
    },
    features: ["Singleplayer", "Multiplayer", "Controller Support", "Hi-Res Textures", "Mod Support", "Open Source"],
    tags: ["FPS", "Sci-Fi", "Classic", "Official", "Remaster"],
    verificationLevel: "playbound_verified",
  },
  {
    gameSlug: "alephone",
    slug: "marathon-1",
    name: "Marathon (1994) – Hi-Res Edition",
    shortDescription: "Bungie's 1994 classic FPS in Aleph One with community HD textures and 3D weapon models pre-installed.",
    description:
      "Where the story began: defend the colony ship UESC Marathon against the Pfhor invasion. Includes the complete original 1994 scenario running on Aleph One with pre-configured high-resolution texture replacements, 3D monster/weapon models, and native controller support.",
    type: "enhanced",
    status: "active",
    visibility: "public",
    isDefault: false,
    ...
    installConfig: {
      playbound_installer: {
        ...
        note: "Includes the Aleph One engine, Marathon (M1) scenario, and high-resolution texture mod pack.",
      },
    },
    features: ["Singleplayer", "Classic Campaign", "Controller Support", "Hi-Res Textures", "Open Source"],
    tags: ["FPS", "Prequel", "Retro", "Remaster"],
    verificationLevel: "community_verified",
  },
  {
    gameSlug: "marathon-2",
    slug: "official",
    name: "Marathon 2: Durandal – XBLA HD Edition",
    shortDescription: "The complete Marathon 2 scenario bundled with Aleph One and high-definition XBLA assets.",
    description:
      "Bungie's 1995 sequel remastered on the open-source Aleph One engine with modern widescreen resolutions, high-definition Xbox Live Arcade (XBLA) graphics, 60fps mouselook, and native controller support.",
    type: "official",
    status: "active",
    visibility: "public",
    isDefault: true,
    ...
    installConfig: {
      playbound_installer: {
        ...
        assetPattern: "^Marathon2-\\d{8}-Win\\.zip$",
        exeHint: "Marathon2.exe",
        note: "Includes the Aleph One engine, full Marathon 2 scenario, and high-definition XBLA graphical replacements.",
      },
    },
    features: ["Singleplayer", "Multiplayer", "Controller Support", "Hi-Res Textures", "Mod Support", "Open Source"],
    tags: ["FPS", "Sci-Fi", "Classic", "Official", "Remaster"],
  ...
  },
  {
    ...
    shortDescription: "The mind-bending finale in Aleph One with high-resolution landscapes and creature textures.",
    description:
      "Marathon Infinity concludes the trilogy with non-linear realities, multiple timelines, and expanded multiplayer weapons on the Aleph One engine, pre-configured with high-resolution texture replacements and native controller support.",
    type: "enhanced",
    status: "active",
    visibility: "public",
    isDefault: false,
    ...
    installConfig: {
      playbound_installer: {
        ...
        note: "Includes the Aleph One engine, Infinity scenario, and pre-packaged high-definition texture replacements.",
      },
    },
    features: ["Singleplayer", "Multiplayer", "Non-linear Campaign", "Controller Support", "Hi-Res Textures", "Open Source"],
    tags: ["FPS", "Finale", "Sci-Fi", "Remaster"],
    verificationLevel: "community_verified",
  },
  ...
  // --- Team Fortress 2 ---
  {
    ...
    tags: ["Official", "Valve", "Class Shooter"],
    verificationLevel: "playbound_verified",
  },
  {
    gameSlug: "team-fortress-2",
  ...
  },
  {
    ...
    tags: ["Arena Shooter", "FPS", "Competitive", "Esports"],
  ...
  },
  {
    ...
    tags: ["MOBA", "Esports", "Strategy", "Vulkan"],
  ...
  },
  {
    ...
    tags: ["Open World", "Action RPG", "Anime", "Co-op"],
  ...
  },
  {
    ...
    tags: ["Epic Games", "Open World", "Action RPG"],
    verificationLevel: "official",
  },
  {
  ...
  },
  {
    ...
    requirements: {
      min: "1.0 GHz CPU / 1 GB RAM / OpenGL 2.0 / 100 MB storage",
      recommended: "Quad-Core CPU / 2 GB RAM / Dedicated GPU / USB Gamepads",
    },
  ...
  },
  {
    ...
    slug: "rvgl-original",
    name: "Re-Volt (RVGL) — Original Soundtrack Edition (Default)",
    shortDescription: "The definitive 64-bit RVGL release with original soundtrack, Dreamcast tracks, and full controller support.",
    description:
      "The full modern RVGL package for Re-Volt on Windows. Includes the updated high-definition engine, the full classic soundtrack, Dreamcast bonus cars and tracks, and plug-and-play controller configuration.",
    type: "community",
    status: "active",
    visibility: "public",
    isDefault: true,
  ...
  },
  {
    gameSlug: "re-volt-rvgl",
    slug: "rvgl-online",
    name: "Re-Volt (RVGL) — Community Online Edition",
    shortDescription: "RVGL packed with community cars, modern tracks, and custom online multiplayer content.",
    description:
      "An expanded RVGL installation featuring community-created multiplayer tracks, bonus vehicles, custom sound packs, and competitive online presets.",
    type: "community",
    status: "active",
    visibility: "public",
    isDefault: false,
    ...
    installConfig: {
      playbound_installer: {
        ...
        fileName: "rvgl_full_win64_online.zip",
        exeHint: "rvgl",
        note: "Community expanded Re-Volt (RVGL) 64-bit Windows release.",
      },
    },
    requirements: {
      min: "1.0 GHz CPU / 512 MB RAM / OpenGL 2.1 / 600 MB storage",
      recommended: "Dual-Core CPU / 2 GB RAM / Dedicated GPU / USB Gamepad",
    },
    features: ["Singleplayer", "Multiplayer", "Controller Support", "Custom Tracks", "Community Content"],
    tags: ["Racing", "Arcade", "Community Content", "Online Multiplayer"],
    aliases: ["RVGL Online", "Re-Volt Community Edition"],
    version: "23.1030a",
    verificationLevel: "community_verified",
  },
  {
    ...
    shortDescription: "Play wipEout instantly in any modern web browser via WebAssembly.",
    description:
      "The PhobosLab WebAssembly rewrite of wipEout running directly in your web browser. Features hardware-accelerated 3D rendering and instant browser play without local installation.",
    type: "community",
    status: "active",
    visibility: "public",
    isDefault: true,
    ...
    installConfig: {
      browser: {
        playUrl: "https://phoboslab.org/wipegame/",
      },
    },
    requirements: {
      min: "Modern web browser (Chrome, Edge, Firefox, Safari) with WebGL support",
    },
    features: ["Singleplayer", "Browser Playable", "WebGL 3D"],
    tags: ["Browser", "WebAssembly", "WebGL", "Retro"],
    aliases: ["Wipeout Web", "Wipegame"],
    version: "Web",
    verificationLevel: "community_verified",
  },
  {
  ...
  },
  {
    ...
    tags: ["Fighting", "Platform Fighter", "PvP", "Esports"],
  ...
  },
  {
    gameSlug: "openhv",
    slug: "standalone-pc",
    name: "OpenHV Standalone Edition (Default)",
    shortDescription:
    ...
    requirements: {
      min: "1.0 GHz CPU / 1 GB RAM / OpenGL 2.0 / 200 MB storage",
      recommended: "Dual-Core CPU / 2 GB RAM / Dedicated GPU",
    },
    features: ["Singleplayer", "Multiplayer", "Original IP", "Pixel Art", "Dedicated Servers"],
  ...
  // --- Pokémon Blaze Online ---
  {
    ...
    slug: "official",
    name: "Pokémon Blaze Online (64-bit Default)",
    shortDescription: "Official 64-bit desktop client for Windows, Linux, and macOS.",
    description:
      "The primary 64-bit client for Pokémon Blaze Online. Explore Kanto, Johto, Hoenn, and Sinnoh with full co-op battles, trading, and cross-platform sync.",
    type: "official",
    status: "active",
    visibility: "public",
    isDefault: true,
    ...
    links: {
      ...
      discord: "https://discord.gg/QeZcXubj9y",
      forum: "https://forums.pokemonblazeonline.com/",
    },
    installMethod: "playbound_installer",
    installConfig: {
      playbound_installer: {
        kind: "direct-zip",
        url: "https://pbo-downloads.s3.eu-central-003.backblazeb2.com/pbo-windows.zip",
        urlLinux: "https://d5umvyciulivv.cloudfront.net/pbo-linux.tar.gz",
        urlMac: "https://pbo-downloads.s3.eu-central-003.backblazeb2.com/pbo-mac.dmg",
        fileName: "pbo-windows.zip",
        versionLabel: "64-bit",
        exeHint: "pbo|PBO",
        knownExePaths: ["pbo.exe", "PBO.exe", "pbo"],
        note: "Official 64-bit native package. Linux downloads native tarball; macOS downloads DMG.",
      },
    },
    platforms: ["Windows", "Linux", "macOS"],
    features: ["Singleplayer", "Multiplayer", "Co-op", "Dedicated Servers", "Cross-play", "Controller Support", "Community Content"],
    tags: ["2D", "Pixel Art", "Open World", "Turn-Based", "Co-op"],
  ...
  },
  {
    gameSlug: "pokemon-blaze-online",
    slug: "windows-32",
    name: "Pokémon Blaze Online (Windows 32-bit Legacy)",
    shortDescription: "Official 32-bit Windows client for older x86 machines.",
    description:
      "The official 32-bit legacy client build of Pokémon Blaze Online, maintained for older 32-bit Windows machines and low-spec systems.",
    type: "official",
    status: "active",
    visibility: "public",
    isDefault: false,
    sortOrder: 20,
    links: {
      website: "https://www.pokemonblazeonline.com/downloads",
      discord: "https://discord.gg/QeZcXubj9y",
    },
    installMethod: "playbound_installer",
    installConfig: {
      playbound_installer: {
        kind: "direct-zip",
        url: "https://pbo-downloads.s3.eu-central-003.backblazeb2.com/pbo-windows-32.zip",
        fileName: "pbo-windows-32.zip",
        versionLabel: "32-bit Legacy",
        exeHint: "pbo|PBO",
        knownExePaths: ["pbo.exe", "PBO.exe"],
        note: "Official 32-bit x86 Windows package for legacy hardware.",
      },
    },
    platforms: ["Windows"],
    features: ["Singleplayer", "Multiplayer", "Co-op", "Dedicated Servers", "Controller Support", "Community Content"],
    tags: ["2D", "Pixel Art", "Open World", "Turn-Based", "Co-op"],
    hasControllerSupport: true,
    verificationLevel: "official",
  },
  // --- PokeMMO ---
  {
    gameSlug: "pokemmo",
    slug: "official",
    name: "PokeMMO Client (Portable Multi-Region)",
    shortDescription: "Official portable PokeMMO client uniting five handheld generations.",
    description:
      "The official portable cross-platform PokeMMO client. Run PokeMMO.exe on Windows or PokeMMO.sh on Linux. Supply your legally owned base ROMs (Pokémon Black/White required) on first launch.",
    type: "official",
    status: "active",
    visibility: "public",
    isDefault: true,
    ...
    installConfig: {
      playbound_installer: {
        ...
        urlLinux: "https://dl.pokemmo.com/PokeMMO-Client.zip",
        fileName: "PokeMMO-Client.zip",
        versionLabel: "Portable Client",
        exeHint: "PokeMMO|PokeMMO.exe|PokeMMO.sh",
        knownExePaths: ["PokeMMO.exe", "PokeMMO.sh"],
        note: "Official portable multi-region client. Supply Pokémon Black/White 1 ROM on first launch.",
      },
    },
    platforms: ["Windows", "Linux", "macOS"],
    features: ["Singleplayer", "Multiplayer", "Dedicated Servers", "Cross-play", "Controller Support", "Ranked Ladder", "Community Content"],
    tags: ["2D", "Pixel Art", "Competitive", "Turn-Based", "Open World"],
    hasControllerSupport: true,
    verificationLevel: "official",
  },
  {
    gameSlug: "castlevania-revamped",
    slug: "official",
    name: "Castlevania ReVamped (Standalone)",
    shortDescription: "Official standalone PC Metroidvania release.",
    description:
      "The complete, standalone version of Castlevania ReVamped for PC. Features fluid 8-way whipping, wall-jumping, sliding, item upgrades, and native controller support out of the box.",
    type: "official",
    status: "active",
    visibility: "public",
    sortOrder: 1,
    ...
    isStandalone: true,
    branding: {
      heroImage: "https://raw.githubusercontent.com/LSDonkeyKong/Castlevania-ReVamped-Open-Source-Edition/main/icon.png",
      screenshots: [],
    },
    links: {
      github: "https://github.com/LSDonkeyKong/Castlevania-ReVamped-Open-Source-Edition",
    },
    installMethod: "playbound_installer",
    installConfig: {
      playbound_installer: {
        ...
        knownExePaths: ["Castlevania ReVamped.exe", "CastlevaniaReVamped.exe"],
        note: "Standalone Metroidvania engine with native XInput and DirectInput controller support.",
      },
    },
    platforms: ["Windows", "Linux"],
    features: ["Singleplayer", "Controller Support"],
    tags: ["2D", "Pixel Art", "Retro", "Side Scroller", "Singleplayer"],
    hasControllerSupport: true,
    verificationLevel: "official",
  },
  {
    ...
    slug: "official",
    name: "Hawkening Client",
    shortDescription: "Official community revival client for Hawken.",
    description:
      "The official Hawkening community client, featuring dedicated 6v6 matchmaking, persistent pilot progression, custom mech loadouts, and native gamepad support.",
    type: "official",
    status: "active",
    visibility: "public",
    sortOrder: 1,
    ...
    isStandalone: true,
    branding: {
      heroImage: "https://hawakening.com/images/hero-mech.jpg",
      screenshots: [],
    },
    links: {
      website: "https://hawakening.com/",
      discord: "https://discord.gg/JzrB5Vskpn",
    },
    installMethod: "playbound_installer",
    installConfig: {
      playbound_installer: {
        kind: "direct-installer",
        url: "https://hawakening.com/downloads/Hawkening-Setup.msi",
        fileName: "Hawkening-Setup.msi",
        versionLabel: "Community Client",
        exeHint: "Hawkening|Hawken|Hawken-Win32-Shipping",
        knownExePaths: ["Hawken.exe", "Hawken-Win32-Shipping.exe"],
        note: "Community client setup package. Create your pilot callsign at hawakening.com before initial launch.",
      },
    },
    platforms: ["Windows"],
    features: ["Multiplayer", "Co-op", "Dedicated Servers", "Controller Support", "Team Play"],
    tags: ["Mechs", "Sci-Fi", "PvP", "First-Person", "Arena Shooter"],
    hasControllerSupport: true,
    verificationLevel: "official",
  },
  {
  ...
  },
  {
    gameSlug: "morrowind",
    slug: "rebirth",
    name: "Morrowind Rebirth — Total Overhaul",
    version: "6.6",
    shortDescription:
      "Total overhaul rebalancing Vvardenfell with expanded cities, redesigned dungeons, new gear, and rebalanced magic.",
    description:
      "Morrowind Rebirth is a monumental total overhaul for The Elder Scrolls III: Morrowind. It enriches and expands every city and settlement on Vvardenfell, overhauls dungeons and wilderness encounter design, rebalances the entire economy and enchanting progression, adds hundreds of new weapons, armor, and clutter items, and refines creature level lists. Fully compatible with OpenMW.",
    type: "community",
    status: "active",
    visibility: "public",
    isDefault: false,
    sortOrder: 25,
    links: { website: "https://www.moddb.com/mods/morrowind-rebirth" },
    installMethod: "external_installer",
    installConfig: { external_installer: { url: "https://www.moddb.com/mods/morrowind-rebirth" } },
    features: ["Singleplayer", "Mod Support", "Community Content", "Story Campaign", "Total Overhaul"],
    tags: ["RPG", "Open World", "Total Overhaul", "Fantasy"],
    aliases: ["Morrowind Rebirth", "Rebirth"],
    verificationLevel: "community_verified",
  },
  {
    gameSlug: "heroes-of-might-and-magic-3-complete",
    slug: "hota",
    name: "Heroes of Might and Magic III: Horn of the Abyss (HotA)",
    version: "1.7.2",
    shortDescription:
      "The definitive community expansion introducing the Cove and Factory factions, new campaigns, and online lobby.",
    description:
      "Horn of the Abyss (HotA) is the gold standard expansion for Heroes of Might and Magic III: Complete. It introduces two fully-developed new factions (the piratical Cove and the industrial-steampunk Factory), original story campaigns, simultaneous turns for multiplayer, an active built-in online lobby, naval battlefield mechanics, new neutral creatures, and tournament-caliber balance.",
    type: "community",
    status: "active",
    visibility: "public",
    isDefault: false,
    sortOrder: 15,
    links: { website: "https://h3hota.com/en/download" },
    installMethod: "playbound_installer",
    installConfig: {
      playbound_installer: {
        kind: "direct-installer",
        url: "https://download.h3hota.com/HotA_1.7.2_setup.exe",
        fileName: "HotA_1.7.2_setup.exe",
        versionLabel: "1.7.2",
        exeHint: "HotA|Heroes3",
        note: "Official HotA setup. Installs into your Heroes of Might and Magic III: Complete folder.",
      },
    },
    features: ["Singleplayer", "Multiplayer", "Competitive", "Community Content", "Turn-Based Strategy"],
    tags: ["Strategy", "Turn-Based", "Fantasy", "Expansion"],
    aliases: ["Horn of the Abyss", "HotA"],
    verificationLevel: "community_verified",
  },
  {
    gameSlug: "heroes-of-might-and-magic-3-complete",
    slug: "wog",
    name: "Heroes of Might and Magic III: In the Wake of Gods (WoG / ERA 3)",
    version: "3.9.6",
    shortDescription:
      "Total conversion platform adding Commander battlefield units, creature experience, and modular ERM scripting.",
    description:
      "In the Wake of Gods (WoG) / ERA 3 is a comprehensive total conversion platform that transforms Heroes III mechanics. Heroes are accompanied into tactical combat by unique Commander avatars, creatures gain experience and ranks through battle, and the modular Event Related Model (ERM) scripting engine unlocks hundreds of configurable options, unique map dwellings, and customizable artifacts.",
    type: "community",
    status: "active",
    visibility: "public",
    isDefault: false,
    sortOrder: 20,
    links: { website: "https://heroes3wog.net/era-3-download-installation/" },
    installMethod: "external_installer",
    installConfig: { external_installer: { url: "https://heroes3wog.net/era-3-download-installation/" } },
    features: ["Singleplayer", "Community Content", "Total Conversion", "Turn-Based Strategy"],
    tags: ["Strategy", "Turn-Based", "Fantasy", "Total Conversion"],
    aliases: ["In the Wake of Gods", "WoG", "ERA 3"],
    verificationLevel: "community_verified",
  },
  {
    gameSlug: "freelancer",
    slug: "discovery",
    name: "Discovery Freelancer — Living Universe MMO Edition",
    version: "5.0",
    shortDescription:
      "15-year community masterwork turning Freelancer into an open galaxy with 100+ systems and pilotable capital ships.",
    description:
      "Discovery Freelancer is an ongoing total conversion and multiplayer roleplay universe. It dramatically expands the Sirius sector with over 100 interconnected star systems, pilotable dreadnoughts, battleships, and carriers, constructible player bases, dynamic economy mechanics, and persistent community-hosted roleplay servers.",
    type: "community",
    status: "active",
    visibility: "public",
    isDefault: false,
    sortOrder: 20,
    links: { website: "https://discoverygc.com/" },
    installMethod: "playbound_installer",
    installConfig: {
      playbound_installer: {
        kind: "direct-installer",
        url: "https://discoverygc.com/files/DiscoveryFreelancerSetup.exe",
        fileName: "DiscoveryFreelancerSetup.exe",
        versionLabel: "5.0",
        exeHint: "Freelancer|Discovery",
        note: "Standalone installer featuring Discovery's official auto-updating game launcher.",
      },
    },
    features: ["Multiplayer", "MMO", "Community Content", "Space Sim"],
    tags: ["Space", "Sci-Fi", "MMO", "Flight"],
    aliases: ["Discovery Freelancer", "Discovery FL"],
    verificationLevel: "community_verified",
  },
  {
    gameSlug: "freelancer",
    slug: "crossfire",
    name: "Freelancer: Crossfire — Total Conversion",
    version: "2.0",
    shortDescription:
      "Massive graphical and narrative expansion with 150+ systems, HD shaders, and new storyline.",
    description:
      "Crossfire is an expansive singleplayer and multiplayer total conversion for Freelancer. It integrates an updated graphics engine with real-time dynamic lighting, destructible space stations, 150+ solar systems, and a continuation campaign that takes Edison Trent beyond Sirius into deep alien territory.",
    type: "community",
    status: "active",
    visibility: "public",
    isDefault: false,
    sortOrder: 30,
    links: { website: "https://www.moddb.com/mods/crossfire" },
    installMethod: "external_installer",
    installConfig: { external_installer: { url: "https://www.moddb.com/mods/crossfire" } },
    features: ["Singleplayer", "Multiplayer", "Community Content", "Story Campaign", "Total Conversion"],
    tags: ["Space", "Sci-Fi", "Total Conversion"],
    aliases: ["Crossfire Freelancer", "Crossfire"],
    verificationLevel: "community_verified",
  },
  {
    gameSlug: "freelancer",
    slug: "shattered-worlds",
    name: "Shattered Worlds: Warpath — Fleet Combat Edition",
    version: "1.6",
    shortDescription:
      "Tactical multiplayer total conversion focused on capital fleet battles, carrier logistics, and territory control.",
    description:
      "Shattered Worlds: Warpath re-engineers Freelancer into a tactical space warfare simulator. It emphasizes carrier flight operations, capital ship broadsides, electronic countermeasures, and strategic sector territorial conquest across dynamic faction fronts.",
    type: "community",
    status: "active",
    visibility: "public",
    isDefault: false,
    sortOrder: 40,
    links: { website: "https://www.moddb.com/mods/shattered-worlds-warpath" },
    installMethod: "external_installer",
    installConfig: { external_installer: { url: "https://www.moddb.com/mods/shattered-worlds-warpath" } },
    features: ["Multiplayer", "Community Content", "Tactical", "Space Sim"],
    tags: ["Space", "Sci-Fi", "Tactical"],
    aliases: ["Shattered Worlds", "Warpath"],
    verificationLevel: "community_verified",
  },
  {
    gameSlug: "cataclysm-dda",
    slug: "bright-nights",
    name: "Cataclysm: Bright Nights — Standalone Tactical Fork",
    version: "0.9",
    shortDescription:
      "Standalone fork refocusing on tactical sci-fi combat, vehicle engineering, and electricity grids.",
    description:
      "Cataclysm: Bright Nights is an independent standalone fork of CDDA. It removes cumbersome micro-management mechanics to emphasize action-packed sci-fi survival, responsive bionics, robust electrical grid management, intuitive vehicle construction, and balanced endgame combat against mutagens and robotic horrors.",
    type: "community",
    status: "active",
    visibility: "public",
    isStandalone: true,
    ...
    sortOrder: 20,
    links: {
      website: "https://github.com/cataclysmbnteam/Cataclysm-BN",
      github: "https://github.com/cataclysmbnteam/Cataclysm-BN",
    },
    installMethod: "playbound_installer",
    installConfig: {
      playbound_installer: {
        kind: "direct-zip",
        url: "https://github.com/cataclysmbnteam/Cataclysm-BN/releases/download/cbn-0.9/cbn-windows-x64-tiles.zip",
        fileName: "cbn-windows-x64-tiles.zip",
        versionLabel: "0.9",
        exeHint: "cataclysm-tiles|cbn-tiles",
        note: "Standalone portable release. Unpacks and runs directly without requiring base CDDA.",
      },
    },
    features: ["Singleplayer", "Open Source", "Roguelike", "Standalone"],
