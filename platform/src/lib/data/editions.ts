...
export const editions: EditionSeed[] = [
  ...
  },
  {
    ...
    description:
      "Anomaly is the great open-ended Zone: every major region, faction starts, story routes, and enough tuning to make the same road feel different twice. PlayBound will wire a one-click installer once the staged package URL is finalized; until then the ModDB page remains the upstream download.",
    type: "community",
    status: "active",
    visibility: "public",
    isDefault: false,
