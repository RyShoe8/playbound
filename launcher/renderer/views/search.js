...
/*
 * Tags and features come from the website, not from this file.
 *
 * These were hardcoded here and had drifted to 37 tag values that were
 * mostly invented (Deckbuilder, Voxel, Nostalgic) and matched little or
 * nothing in the catalog, so the desktop app and the site offered different
 * filters for the same games. vocabulary.js is regenerated by
 * scripts/sync-catalog.js from the same API response that refreshes
 * catalog.js, so the two surfaces cannot drift again.
 */
import { TAGS, FEATURES } from "../vocabulary.js";

// Re-exported because other views import them from here.
export { TAGS, FEATURES };
